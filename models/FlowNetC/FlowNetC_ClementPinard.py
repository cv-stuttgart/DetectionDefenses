...
from .util_ClementPinard import conv, predict_flow, deconv, crop_like, correlate
...
class FlowNetC(nn.Module):
    ...
    def forward(self, x1, x2):
        ...
        print(f'1. min and max of flow: {torch.min(flow2)} // {torch.max(flow2)}')
        print(f'1. shape of flow: {flow2.shape}')
